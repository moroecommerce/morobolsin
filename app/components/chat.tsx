...
const IconPartner = (
  <svg width="18" height="18" fill="none" viewBox="0 0 20 20">
    ircle cx="10" cy="6.5" r="3.3" stroke="#5a6573" strokeWidth="1.5" />
    <path
...
const BENEFITS = [
  {
    ...
    text: "Помогаем подобрать форму для шефов, поваров, бариста и официантов под стиль вашего заведения.",
  },
  {
    emoji: "✨",
    title: "Современный дизайн",
    text: "Каждый комплект продуман до деталей: крой, посадка и материалы создают ощущение премиального сервиса.",
  },
  {
    emoji: "🧵",
    title: "Индивидуальный подход",
    text: "Наносим логотипы, подбираем цвета под бренд и собираем комплекты под ваш формат: кафе, ресторан, отель.",
  },
  {
    emoji: "🧺",
    title: "Практичные ткани",
    text: "Используем материалы, устойчивые к частым стиркам, пятнам и высокой нагрузке на кухне и в зале.",
  },
  {
    emoji: "🚚",
...
const REVIEWS = [
  {
    ...
    text: "Morobolsin разработали элегантную и практичную униформу для ресепшн и ресторана. Гости сразу отмечают аккуратный внешний вид команды.",
  },
  {
    name: "Chef Aziz",
    badge: "Шеф‑повар",
    problem: "Форма для кухни и открытой линии",
    text: "Кителя удобные, не сковывают движения и хорошо выглядят в кадре. Для команды сделали разные модели под роли.",
  },
  {
    name: "Coffee Place",
    badge: "Кофейня",
    problem: "Единый стиль бариста",
    text: "Фартуки и рубашки в фирменных цветах помогают выделить бренд. Материалы выдерживают ежедневную нагрузку.",
  },
];
        ...
        {REVIEWS.map(({ name, badge, problem, text }, idx) => (
          ...
          >
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div
                style={{ fontSize: 13, color: "#3a3a3a", lineHeight: "1.64" }}
              >
                {text}
              </div>
            </div>
  ...
  const EXAMPLES = [
    {
      ...
      a: "Расскажите о концепции заведения, количестве персонала и основных ролях. Предложу варианты кителей, фартуков и рубашек, которые будут гармонировать со стилем интерьера и брендом.",
    },
    {
      q: "Хотим обновить форму официантов под новый стиль меню.",
      a: "Опишите цвета бренда и общий тон заведения. Подберём фартуки и рубашки так, чтобы они подчёркивали атмосферу и выглядели современно на фото и видео.",
    },
    {
      q: "Нужна практичная форма для бариста.",
      a: "Уточните загрузку точки и формат кофейни. Подскажу ткани и модели фартуков, которые выдержат частые стирки и сохранят аккуратный вид.",
    },
    {
      q: "Хотим добавить логотип на форму.",
      a: "Пришлите логотип и основные цвета бренда. Посоветуем оптимальное размещение и тип нанесения, чтобы логотип выглядел чётко и не мешал в работе.",
    },
  ];
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text: "Профессиональная униформа для шефов, поваров, бариста и официантов.",
          ...
          >
            <div style={{ width: "100%", textAlign: "center" }}>
              ...
              <div style={{ fontSize: 13, color: "#7c8792" }}>
                Ответьте на несколько вопросов — подберём варианты под ваш
                формат
              </div>
            </div>
          </div>
