...
const REVIEWS = [
  {
    ...
    text:
      "Morobolsin разработали элегантную и практичную униформу для ресепшн и ресторана. Гости сразу отмечают аккуратный внешний вид команды.",
  },
  {
    name: "Chef Aziz",
    badge: "Шеф‑повар",
      ...
      >
        ...
        >
          ...
          >
            ...
            профессиональную униформу: кителя, фартуки, брюки и рубашки для
